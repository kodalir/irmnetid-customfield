package gov.dhs.ice.jira.plugin.customfields;
...
import gov.dhs.ice.jira.plugin.customfields.ajax.AjaxViewHelper;
import gov.dhs.ice.jira.plugin.customfields.config.ConfigUtils;
import gov.dhs.ice.jira.plugin.customfields.utils.RestFetcher;
...
@Scanned
public class IrmnetIdCustomField extends GenericTextCFType implements SortableCustomField<String>/*implements SortableCustomField*//*implements MultipleSettableCustomFieldType,
		MultipleCustomFieldType,
		SortableCustomField*/ {

    // ------------------------------ FIELDS ------------------------------
    private static final Logger logger = Logger.getLogger(IrmnetIdCustomField.class);
    ...
    protected IrmnetIdCustomField(PluginSettingsFactory pluginSettingsFactory, CustomFieldValuePersister customFieldValuePersister, GenericConfigManager genericConfigManager, TextFieldCharacterLengthValidator textFieldCharacterLengthValidator, JiraAuthenticationContext jiraAuthenticationContext) {
